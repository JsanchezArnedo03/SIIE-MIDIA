...
/*ROL 1. Empleado 2. Estudiante 3. Acudiente
*/
CREATE TABLE rol (
...
/*CARGO 1. Director 2. Director Financiero 3. Coordinador Academico 
4. Coordinador Disciplinario 5. Secretario(a) 6. Docente 7. Psicoorientador
*/
CREATE TABLE cargo (
...
/*
TABLAS ENCARGADAS DE LA AUDITORIA Y SEGURIDAD DE LA INFORMACION
*/
CREATE TABLE auditoria (
    id_auditoria BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
CREATE TABLE log_acceso (
    id_log_acceso BIGINT PRIMARY KEY NOT NULL AUTO_INCREMENT,
    id_empresa BIGINT NOT NULL,
